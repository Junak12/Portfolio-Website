...
const Hero = () => {
  ...
  return (
    <div className="px-4 md:px-20" id="home">
      ...
      <div className="mt-4 text-center">
        <h1 className="text-black/60 dark:text-gray-300 text-[24px] font-medium">
          Hi! I'm Junak
        </h1>
        <p className="mt-2 text-black/70 dark:text-gray-300 text-[18px] font-medium">
      ...
      {/* About Section */}
      <div className="mt-14 flex flex-col items-center gap-2 text-center" id="about">
        <h3 className="text-black/60 dark:text-gray-300 text-[18px] font-medium">
          Introduction
        </h3>
        <h1 className="text-black/60 dark:text-gray-300 text-[32px] font-bold">
          About Me
        </h1>
      </div>
      ...
      <div className="mt-10 flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-20">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-[16px] text-black/80 dark:text-gray-400 font-medium">
            ...
            Passionate about coding and problem-solving, with a Codeforces rating
            of 1283 and 3⭐ on CodeChef.
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
            {[
              ...
              },
              {
                icon: expicon,
                title: "Projects",
                content: "Built more than 3 projects"
              }
            ].map((card, index) => (
              <div
                key={index}
              ...
              >
                ...
                <p className="text-[18px] font-semibold text-black/75 dark:text-gray-700">
                  {card.title}
                </p>
                <p className="text-[14px] font-medium text-black/55 dark:text-gray-300 whitespace-pre-line">
                  {card.content}
                </p>
              </div>
            ))}
          ...
          <div className="flex flex-col gap-4 mt-4">
            <h1 className="text-[18px] text-black/80 dark:text-gray-300 font-semibold">
              Tools I Use
            </h1>
              ...
              {[vscodeicon, firebaseicon, mogodbicon, figmaicon, giticon].map((icon, idx) => (
                <div
                  ...
                  className="
                    ...
                    rounded-xl p-2 bg-white dark:bg-[#1F2933]
                    hover:scale-110 transition
                  "
                >
                  <img className="w-8 h-8 object-contain" src={icon} alt="" />
                </div>
              ))}
            </div>
          </div>
